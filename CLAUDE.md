...
# Files you should probably ignore

1. learning-how-to-use-claude-code.txt -> Just something for me to start getting used to Claude Caude and learning to utilize its full abilities

2. pdf-task.pdf -> The task I described in this file, just in PDF format.

# Git Commit Guidelines

All git commits should include the following attribution:

```
Coded with Claude Code & Reviewed by Ilan Yashuk
```

This should be added at the end of every commit message to properly attribute the collaborative work.
